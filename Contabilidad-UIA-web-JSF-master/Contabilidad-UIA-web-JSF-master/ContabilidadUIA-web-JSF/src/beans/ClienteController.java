...
public class ClienteController {
	...
	public ArrayList<String> chequesNames = null;
	...
	public ArrayList<String> getChequesNames() {
		if(this.proveedor == null)
		{
			this.proveedores = this.dao.getListaProveedores();
			proveedor = this.proveedores.get(0);			
		}
		chequesNames=this.dao.getChequesNames(this.proveedor.getName());
		return chequesNames;
	}
	...
	public void setChequesNames(ArrayList<String> chequesNames) {
		this.chequesNames = chequessNames;
	}
	...
	public void setCheques(ArrayList<ClienteJSF> cheques) {
